...
export const OrbitalNav = ({ nodes, view, setView, stickPos, setStickPos, onOpenAdmin, onOpenAppearance, onResetLayout }) => {
  ...
  // Note: We've removed the local setStickPos listeners here to resolve performance lag.
  // The master animate loop in App.jsx now handles the inertia directly from the raw values.
