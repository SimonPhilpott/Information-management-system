      ...
      >
        ...
        {!isFolder && (
          <div className="catalog-actions">
            ...
            <button className="catalog-action-btn" title="Open Document" onClick={(e) => {
              e.stopPropagation();
              onOpenFile(item.driveFileId, 1, item.name);
            }}>
              <ExternalLink size={14} />
            </button>
            <button className="catalog-action-btn" title="Move Document" onClick={(e) => {
              e.stopPropagation();
              onMoveTo(item);
            }}>
              <Move size={14} />
            </button>
            <button className="catalog-action-btn delete" title="Delete Document" onClick={(e) => {
              e.stopPropagation();
        ...
        {confirmDelete && (
          <div className="sub-modal-overlay">
            <div className={`sub-modal ${isDeleting ? 'processing' : 'danger'}`}>
              ...
              <h3>{isDeleting ? 'Deleting Documents...' : `Delete ${confirmDelete.length === 1 ? 'Document' : 'Documents'}?`}</h3>
              
              {!isDeleting ? (
                <p>This will remove {confirmDelete.length === 1 ? 'this document' : 'these documents'} from your library index and local cache. This action cannot be undone.</p>
              ) : (
          ...
          <div className="sub-modal-overlay">
            <div className="sub-modal">
              ...
              <div className="sub-modal-buttons">
                ...
                <button className="btn-primary" onClick={() => handleMove(document.querySelector('.modal-input').value)}>Move Document</button>
              </div>
            </div>
          </div>
        )}
