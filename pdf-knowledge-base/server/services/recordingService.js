...
const NAME = "(?:ims|i\\.?['’]?\\s?m\\.?\\s?s\\.?|im's|imz|aims|eims|ems|eems|emms|hims|imms)";
...
const CANCEL_TAIL = '(?:\\s+(?:please|now|it|thanks|everything|that|this|the|alarm|timer|reminder|ringing|noise))*[\\s.!?]*$';
